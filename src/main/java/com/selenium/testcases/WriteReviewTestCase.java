...
public class WriteReviewTestCase {
	...
	/*
	 * @Test(priority=2, dataProvider = "getSearchdetails", dependsOnMethods=
	 * {"reviewProduct"}) public void reviewProduct1(Hashtable<String, String>
	 * data1) throws InterruptedException { SignOutPage homePage = new
	 * SignOutPage(driver);
	 * System.out.println("the search value is:"+data1.get("SearchName"));
	 * homePage.search(data1.get("SearchName")); Thread.sleep(4000);
	 * searchBox.selectProduct(); ProductPage productPage = new ProductPage(driver);
	 * Thread.sleep(3000); productPage.productReview();
	 * System.out.println("review button clicked"); }
	 */
	...
	/*
	 * @DataProvider public Object[][] getSearchdetails() throws IOException {
	 * String ProjectPath = System.getProperty("user.dir");// this will return
	 * project current directory path System.out.println("ProjectPath = " +
	 * ProjectPath); String filepath = ProjectPath + "/src/main/java/com/selenium/testdata";
	 * String filename = "LoginData.xlsx"; String sheetname = "SearchData"; return
	 * ExcelReader.ReadExcelDataToObjArray(filepath, filename, sheetname); }
	 */
