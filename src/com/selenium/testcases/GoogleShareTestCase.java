...
public class GoogleShareTestCase {
	...
	public void googleShare(Hashtable<String, String> data) throws InterruptedException {
		...
		/*Pair<WebDriver, String> driverAndChildWindowHandle = productPage.googleShare();
		driverAndChildWindowHandle.getLeft().close();
		driver.switchTo().window(driverAndChildWindowHandle.getRight());
		
		System.out.println("googleShare method is done");*/
		String googleEmail = data.get("googleEmail");
		productPage.googleShare(googleEmail);
